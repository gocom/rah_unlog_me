...
"Packagist":https://packagist.org/packages/rah/rah_unlog_me | "Issues":https://github.com/gocom/rah_unlog_me/issues

Exclude set of IP addresses from "Textpattern CMS'":https://textpattern.com/ visitor logs. Can automatically filter out your own hits, site admins and hits made by bots. The plugin adds easy-to-use logging options to Textpattern's Preferences panel that allow one to:

* Exclude list of IPs from visitor logs.
* Automatically strip logged-in site editors' visits from logs.
...
After installation, you can find rah_unlog_me's settings from Textpattern's "Preferences panel":https://docs.textpattern.com/administration/preferences-panel, under *Log Exclusions* section.
